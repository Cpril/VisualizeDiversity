...
```
```{r}
trend <- vl_chart(width = 600, height = 300, title = "Percentage of Female Students/Faculty (%)")|>
...
trend
# TODO: add area somehow. One way is to make a line at 50% and shades above and below it.
```
```{r}
Faculty <- Faculty |>
